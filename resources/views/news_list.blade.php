...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="{{ asset('css/news_list.css') }}" rel="stylesheet">
    ...
    <body class="antialiased">
        <div class="news">
            ...
            <div class="news__item item">
                <a class="item__title" href="{{ route('news_item', ['slug' => $item->slug]) }}">
                    {{ $item->title }}
                </a>
                <p class="item__datetime datetime">{{ $item->published_at }}</p>
